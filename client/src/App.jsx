...
import ServerWakeOverlay from './components/serverWake/ServerWakeOverlay'
import { useServerWakeState } from './hooks/useServerWakeState'
...
function App() {
	...
	return (
		<>
			...
			<ServerWakeOverlay loading={isServerWakeVisible} />
		</>
	)
}
